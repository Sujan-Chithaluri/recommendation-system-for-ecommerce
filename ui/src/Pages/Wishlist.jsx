...
import { getWishlistProducts } from "../api/ApiService";
...
const Wishlist = () => {
  ...
  const getResultsFromRDS = useCallback((data) => {
    (async () => {
      try {
        setSpinner(true);
        let response = await getWishlistProducts(...data);
        ...
        <div className="container">
          <div className="d-flex flex-column justify-content-between">
            <div className="border-start border-5 border-primary ps-5 mb-5">
              <h6 className="text-primary text-uppercase">Wishlist Products</h6>
