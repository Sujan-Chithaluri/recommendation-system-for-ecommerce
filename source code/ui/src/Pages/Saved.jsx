...
import { getLikedProducts, getSavedProducts } from "../api/ApiService";
...
const Saved = () => {
  ...
  const getResultsFromRDS = useCallback((data) => {
    (async () => {
      try {
        setSpinner(true);
        let response = await getSavedProducts(...data);
        ...
        <div className="container">
          <div className="d-flex flex-column justify-content-between">
            <div className="border-start border-5 border-primary ps-5 mb-5">
              <h6 className="text-primary text-uppercase">Saved Products</h6>
              <h1 className="display-5 text-uppercase mb-0">
                Products you saved for future
              </h1>
            </div>
          </div>
